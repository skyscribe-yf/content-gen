"""Extract attention weights from Qwen3-1.7B for the article's example sentence."""
import torch
...
OUTPUT_PATH = "/home/skyscribe/srcs/content-gen/content/2026-07-26-Transformer全景/attention_data.json"
...
# Qwen3-1.7B has 28 layers; inspect the first, middle, and final layers.
target_layers = {
    "layer_1": 0,
    "layer_14": 13,
    "layer_28": 27,
